...
import com.example.jadwalsholat.fragment.AbstractFragment;
import com.example.jadwalsholat.fragment.ConventionListFragment;
import com.example.jadwalsholat.fragment.HigherLatitudeModeListFragment;
import com.example.jadwalsholat.fragment.JumuahDelayListFragment;
import com.example.jadwalsholat.fragment.NotificationSoundListFragment;
import com.example.jadwalsholat.fragment.PrayerTimeFragment;
import com.example.jadwalsholat.fragment.SchoolListFragment;
import com.example.jadwalsholat.fragment.SettingsFragment;
import com.example.jadwalsholat.kiblat.CompassActivity;
import com.example.jadwalsholat.models.MuslimLocation;
import com.example.jadwalsholat.utils.LocationUtils;
import com.example.jadwalsholat.utils.PrayerTimesUtils;
import com.example.jadwalsholat.utils.SharedPreferencesUtils;
import com.example.jadwalsholat.utils.ViewUtils;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
     ...
     * @see com.example.jadwalsholat.utils.LocationUtils
     */
    ...
    public void onResume() {
        ...
        findViewById(R.id.lyt_menu_qibla_container).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent kiblat = new Intent(MainActivity.this, CompassActivity.class);
                startActivity(kiblat);
            }
        });
        findViewById(R.id.lyt_menu_doa_container).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent kiblat = new Intent(MainActivity.this, Main2Activity.class);
                startActivity(kiblat);
            }
        });
    }
