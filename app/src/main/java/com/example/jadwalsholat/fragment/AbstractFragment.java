...
public abstract class AbstractFragment extends Fragment {
    ...
    /** The parent Doa of the Fragment */
    ...
    public void onAttach(Context context){
        ...
        // If the parent activity is instance of Doa, then we set it as the parent
        // Doa
    ...
    /**
     * Returns the parent Doa of the Fragment.
     * @return the parent Doa of the Fragment
     */
